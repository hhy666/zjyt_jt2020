    ...
    initSrpmOption() {
      ...
      requestData(
        ...
        (response) => {
          ...
          _this.returnOptionById(
            _this.tabData[_this.tabId].id,
            response.data.data
          );
        }
      );
              ...
              onclick: function () {
                ...
                if (_this.isShuBan) {
                  ...
                  let chart = echarts.init(
                    $("#" + _this.tabData[_this.tabId].id + " .charts")[0]
                  );
        ...
        legend: [
          {
            ...
            data: [
              {
                name: _this.tabData[_this.tabId].title.replace("本", "2020"),
                icon: "rect",
              },
            ],
          },
