    ...
    >
      ...
      <view class="today_total_kuang">
        ...
        <view class="cbk_body bb">
          <view
            class="yy_view"
            v-for="(item, index) in ttuData"
            :key="index"
            :class="{mb10: index >= ttuData.length - 3}"
          >
            <view class="yyv_up">
        ...
        <!-- 下半部 今日和总量 -->
        <view
          class="cbk_body fdr mt10"
          v-for="(item, index) in ttdData"
          :key="index"
        >
...
export default {
  ...
  methods: {
    findYwskMsgSql1() {
      ...
      requestData(
        ...
        (response) => {
          ...
          for (
            let index = 0;
            index < response.data.data.result.length;
            index++
          ) {
    ...
    findYwskMsgSql1Jt() {
      setTimeout(() => {
        this.findYwskMsgSql1JtQueryAttr(
          "findYwskMsgSql1JtWtdlYear",
          "num",
          this.ttuData[0]
        );
        this.findYwskMsgSql1JtQueryAttr(
          "findYwskMsgSql1JtKgdlYear",
          "num",
          this.ttuData[1]
        );
        this.findYwskMsgSql1JtQueryAttr(
          "findYwskMsgSql1JtWgdlYear",
          "num",
          this.ttuData[2]
        );
        this.findYwskMsgSql1JtQueryAttr(
          "findYwskMsgSql1JtWtjeYear",
          "num",
          this.ttuData[3]
        );
        this.findYwskMsgSql1JtQueryAttr(
          "findYwskMsgSql1JtYcsrYear",
          "num",
          this.ttuData[4]
        );
      }, 1);
      ...
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql1JtWtdlDay",
        "bnum",
        this.ttuData[0]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql1JtKgdlDay",
        "bnum",
        this.ttuData[1]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql1JtWgdlDay",
        "bnum",
        this.ttuData[2]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql1JtWtjeDay",
        "bnum",
        this.ttuData[3]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql1JtYcsrDay",
        "bnum",
        this.ttuData[4]
      );
    },
    ...
    findYwskMsgSql3Jt() {
      ...
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql3JtKhslDay",
        "bnum",
        this.ttdData[0]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql3JtKhslCpxhy",
        "num",
        this.ttdData[0].detail[0]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql3JtKhslFcpxhy",
        "num",
        this.ttdData[0].detail[1]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql3JtKhslFhy",
        2,
        this.ttdData[0].detail
      );
    },
    findYwskMsgSql4() {
      const _this = this;
    ...
    findYwskMsgSql5Jt() {
      ...
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql5JtCzslDay",
        "bnum",
        this.ttdData[2]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql5JtCzslZssl",
        "num",
        this.ttdData[2].detail[0]
      );
      this.findYwskMsgSql1JtQueryAttr(
        "findYwskMsgSql5JtCzslQtcgw",
        "num",
