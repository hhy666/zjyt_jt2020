      ...
      <view class="table_area">
        ...
        >
          <view
            ...
            :key="index"
            :class="{cbl: index == 0,table_tr_nc:tabId == 3 && index == 1, chui: (index > 0 && index%2 == 0), cbai: (index > 0 && index%2 == 1)}"
        ...
        >
          ...
          >
            ...
            >
              <a
                :class="{icon_close:showedChildrenIndex[index] == false, icon_open: showedChildrenIndex[index] == true }"
