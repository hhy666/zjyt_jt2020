      ...
      <view class="table_area">
        ...
        <view class="table_body">
          <view
            ...
            :key="index"
            :class="{cbl: index == 0,table_tr_nc:tabId == 2 && index == 1, chui: (index > 0 && index%2 == 0), cbai: (index > 0 && index%2 == 1)}"
...
export default {
  ...
  created() {
    ...
    this.tabData.push({
      id: 0,
      text: "公司",
      operId: "findJtgsTableGs",
      operId3: "findJtgsTableGsQuyu",
    });
    this.tabData.push({
      id: 1,
      text: "产品线",
      operId: "findJtgsTableCpx",
      operId3: "findJtgsTableCpxQuyu",
    });
    this.tabData.push({
      id: 2,
      text: "客户",
      operId: "findJtgsTableKh",
      operId3: "findJtgsTableKhQuyu",
    });
    ...
    const operId =
      type == 3
        ? this.tabData[this.tabId].operId3
        : this.tabData[this.tabId].operId;
  ...
  methods: {
    ...
    gotoGsDetail(index, idx) {
      ...
      Taro.setStorageSync(
        "showTypeName",
        this.tbodyData[index].children[idx].name
      );
    ...
    initTableData(idx) {
      ...
      this.title =
        idx == 0 ? "按公司统计" : idx == 1 ? "按产品线统计" : "按客户统计";
